...
RETURNING id, membership_name, membership_length, cost, created_by, version
`
...
SELECT id, membership_name, membership_length, cost, created_by, version FROM memberships
WHERE id = $1 AND created_by = $2
`
